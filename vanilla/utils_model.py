...
def train_helper(model: torchvision.models.resnet.ResNet,
    ...
    for epoch in range(1, num_epochs+1):
        ...
        for idx, (inputs, labels, paths) in enumerate(dataloaders["train"]):
            ...
            # Validate the model
            if global_minibatch_counter % val_mb_interval == 0 or global_minibatch_counter == 3:
                ...
                if global_minibatch_counter % save_mb_interval == 0 or global_minibatch_counter == 3:
